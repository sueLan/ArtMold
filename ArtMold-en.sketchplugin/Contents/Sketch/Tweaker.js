...
function runTweaker( lState, rState, tState, bState, wState, hState, kLayerType)
{
    ...
    // 说明文本
    addDescribleView(": Scalable",   0, 0, h + 120, 100, 15);
    addDescribleView(": 2x to 2x, size fixed. 2X to 3X, multiplied by 1.5",  1, 0, h + 90 , 100, 15);
    addDescribleView(": Aspect ratio fixed",   2,    0,h+60    , 100, 15);
    addDescribleView(": Masks of chosen layers not the same",    -1,    0, h+30   , 100, 15 );

    // 显示对话框
    var alertWindow = COSAlertWindow.new();
    alertWindow.addButtonWithTitle(@"OK");
    alertWindow.addButtonWithTitle(@"cancel");
    alertWindow.setMessageText(@"Edit Masks");
